    ...
    return (
        ...
        <div className="login__container">
            ...
            <form>
                ...
                <button className="login__signInButton" type="submit" onClick={signIn}> Sign In</button><br></br>

                <p> By signing-in you agree to Amazon Clone's Conditions of Use & Sale. Please
